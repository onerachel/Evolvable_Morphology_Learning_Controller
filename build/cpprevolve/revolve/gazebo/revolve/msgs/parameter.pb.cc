...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_parameter_2eproto = {
  false, false, 59, descriptor_table_protodef_parameter_2eproto, "parameter.proto", 
  &descriptor_table_parameter_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_parameter_2eproto::offsets,
  file_level_metadata_parameter_2eproto, file_level_enum_descriptors_parameter_2eproto, file_level_service_descriptors_parameter_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_parameter_2eproto_getter() {
  return &descriptor_table_parameter_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_parameter_2eproto(&descriptor_table_parameter_2eproto);
namespace revolve {
namespace msgs {
