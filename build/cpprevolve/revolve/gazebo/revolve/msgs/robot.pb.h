...
class Robot final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::revolve::msgs::Body* release_body();
  ...
  PROTOBUF_MUST_USE_RESULT ::revolve::msgs::NeuralNetwork* release_brain();
...
inline ::revolve::msgs::Body* Robot::_internal_mutable_body() {
  _has_bits_[0] |= 0x00000001u;
  if (body_ == nullptr) {
    auto* p = CreateMaybeMessage<::revolve::msgs::Body>(GetArenaForAllocation());
    body_ = p;
  }
  return body_;
}
inline ::revolve::msgs::Body* Robot::mutable_body() {
  ::revolve::msgs::Body* _msg = _internal_mutable_body();
...
inline ::revolve::msgs::NeuralNetwork* Robot::_internal_mutable_brain() {
  _has_bits_[0] |= 0x00000002u;
  if (brain_ == nullptr) {
    auto* p = CreateMaybeMessage<::revolve::msgs::NeuralNetwork>(GetArenaForAllocation());
    brain_ = p;
  }
  return brain_;
}
inline ::revolve::msgs::NeuralNetwork* Robot::mutable_brain() {
  ::revolve::msgs::NeuralNetwork* _msg = _internal_mutable_brain();
...
inline void Robot::set_allocated_brain(::revolve::msgs::NeuralNetwork* brain) {
  ...
  if (brain) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(brain));
    if (message_arena != submessage_arena) {
