...
class Spline final :
 ...
 public:
  ...
  ~Spline() override;
  explicit constexpr Spline(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ModifyPolicy final :
 ...
 public:
  ...
  ~ModifyPolicy() override;
  explicit constexpr ModifyPolicy(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* ModifyPolicy::add_interpolate() {
  std::string* _s = _internal_add_interpolate();
